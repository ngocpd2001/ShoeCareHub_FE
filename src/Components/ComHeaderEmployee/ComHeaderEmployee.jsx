...
const navigation = [
  ...
  },
  {
    ...
    current: false,
    children: [
      { name: "Dịch vụ", href: "/employee/service" },
      { name: "Đơn hàng", href: "/employee/order" },
    ],
  },
  {
    name: "Đánh giá",
  ...
  },
  {
    ...
    current: false,
    children: [
      { name: "Hồ sơ của tôi", href: "/employee/profile" },
      { name: "Đổi mật khẩu", href: "/employee/reset-password" },
    ],
  },
];
...
export default function ComHeaderEmployee({ children }) {
