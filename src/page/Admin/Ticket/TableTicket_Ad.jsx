...
export const TableTicket_Ad = forwardRef((props, ref) => {
  ...
  const reloadData = async () => {
    ...
    try {
      ...
      if (response && response.tickets) {
        ...
        console.log("Dữ liệu đã được cập nhật:", response.tickets);
        setPagination((prev) => ({
          ...prev,
        ...
        console.log("Phân trang đã được cập nhật:", response.pagination);
      } else {
  ...
  const handleTableChange = (newPagination, filters, sorter) => {
    console.log("handleTableChange được gọi với:", {
      newPagination,
      filters,
      sorter,
    });
    ...
    getAllTicketsMod(
      ...
      .then((response) => {
        ...
        if (response && response.tickets) {
          setData(response.tickets);
          console.log("Dữ liệu mới đã được cập nhật:", response.tickets);
          setPagination((prev) => ({
            ...prev,
            current: response.pagination.currentPage,
            total: response.pagination.totalItems,
