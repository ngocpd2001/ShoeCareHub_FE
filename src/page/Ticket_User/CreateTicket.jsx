...
const CreateTicket = () => {
  ...
  const handleFileUpload = (event) => {
    ...
    if (validFiles.length !== files.length) {
      notificationApi('warning', 'Cảnh báo', 'Chỉ chấp nhận file ảnh (JPG, PNG, GIF) hoặc video (MP4, MOV) và dung lượng dưới 10MB');
    }
        ...
        <div>
          ...
          <div className="bg-orange-50 border border-orange-100 rounded-md p-4 mb-6">
            <p className="text-orange-800">
              ShoeCare Hub rất cần quý khách gởi kèm <span className="font-semibold">hình ảnh/video liên quan đến vấn đề khiếu nại</span>, để ShoeCare Hub nhanh chóng hiểu rõ vấn đề và hỗ trợ quý khách xử lý nhanh nhất có thể.
            </p>
